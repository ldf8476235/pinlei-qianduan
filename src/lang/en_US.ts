export default {
  ...
  login: {
    ...
    mode: 'Standard Login',
    headline: 'Sign in to Category Compass with your account',
    description: 'Access the category analysis workspace to review diagnosis results and business insights.',
    visualSlogan: 'Make every product deliver its maximum value',
    tenantLoading: 'Loading tenant information...',
    tenantLoadFailed: 'Failed to load tenant information. Refresh the page and try again.',
