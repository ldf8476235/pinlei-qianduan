  ...
  <div class="p-2 abc-goods-list-page">
    ...
    <el-card shadow="hover" class="page-card table-card" v-loading="tableLoading">
      ...
      >
        ...
        <el-table-column label="当前状态" prop="productStatus" min-width="120" align="left" sortable="custom">
          <template #default="{ row }">
        ...
        <el-table-column label="本期ABC类别" prop="currentAbc" min-width="110" align="center" sortable="custom" />
        <el-table-column label="对比日期ABC类别" prop="compareAbc" min-width="130" align="center" sortable="custom" />

        <el-table-column label="销售量-总计" prop="saleQuantity" min-width="110" align="center" sortable="custom">
        ...
        <el-table-column label="本期促销" prop="activity" min-width="100" align="center" sortable="custom" />
        <el-table-column label="首次销售日期" prop="firstSaleDate" min-width="130" align="left" sortable="custom" />
        <el-table-column label="本期新品" prop="newProduct" min-width="100" align="center" sortable="custom" />
        <el-table-column label="重点商品" prop="keyProduct" min-width="100" align="center" sortable="custom" />
        <el-table-column label="季节性商品" prop="seasonableFlagName" min-width="110" align="center" sortable="custom">
          <template #default="{ row }">
...
const categoryTitle = computed(() => {
  ...
  const levelName = formatCategoryLevelName(route.query.categoryLevel);
